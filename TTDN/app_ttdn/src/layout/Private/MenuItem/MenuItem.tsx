...
import {AcademicCapIcon, ChartBarSquareIcon, UserGroupIcon, UserIcon, UsersIcon,} from '@heroicons/react/24/outline';
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                label: <Link to={privateRoutesName.subcribeCompany}>Điểm</Link>,
